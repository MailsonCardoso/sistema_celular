...
export default function TrialLimitModal({ feature, onClose }: TrialLimitModalProps) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-amber-400 to-orange-500 shadow-lg shadow-amber-500/30">
